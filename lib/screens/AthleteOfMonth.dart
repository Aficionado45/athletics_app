...
class AthleteOfMonth extends StatefulWidget {

  @override
  _AthleteOfMonthState createState() => _AthleteOfMonthState();
}

class _AthleteOfMonthState extends State<AthleteOfMonth> {
